...
public class ArtikelController {
    ...
    @RequestMapping(value = "/{id}", method = RequestMethod.GET)
    @ResponseBody
    public List<PDArtikel> getArtikelsForRekvisition(@PathVariable("id") Integer id)
    {
        List<PDArtikel> pdartikelList = artikelRepository.getPdArtikelsForRekvis(id);
        return pdartikelList;
    }
